...
export default function Footer() {
  ...
  return (
    <footer className="bg-forest-green text-warm-cream mt-20">
      <div className="max-w-wide mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <ul className="space-y-2">
              {categories.map((category) => (
                <li key={category.href}>
                  <Link
                    href={category.href}
                    className="text-sm text-warm-cream/90 hover:text-white transition-colors"
                  >
                    {category.name}
                  </Link>
                </li>
            ...
            <div className="flex space-x-4 mb-6">
              {siteConfig.socialLinks.twitter && (
                <a
                  ...
                  className="text-warm-cream/90 hover:text-white transition-colors"
                  aria-label="Twitter"
                >
        ...
        <div className="border-t border-warm-cream/20 mt-8 pt-8">
          <p className="text-sm text-center text-warm-cream/80">
            &copy; {currentYear} {siteConfig.siteName}. All rights reserved.
            This site provides educational information and is not a substitute for professional medical advice.
          </p>
        </div>
      </div>
    </footer>
